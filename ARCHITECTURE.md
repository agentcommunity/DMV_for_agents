...
```
 ...
 │  │  GET /badge?domain=name&style=flat|card        │                   │
 │  │    → SVG badge (links back to DMV for SEO)     │                   │
 │  │                                                │                   │
...
| Name squatting | Email verification required to activate. Unique domain constraint. |
